    ...
    <>
      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/hero.gif" height={100} width={100} alt="Background Image" className="object-cover object-center w-full h-full brightness-150" />
          <div className="absolute inset-0 bg-black opacity-50"></div>
        </div>

        <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
          <h1 className="text-5xl font-bold leading-tight mb-4">Welcome to Visiona</h1>
          <p className="text-lg text-gray-300 mb-8 font-bold">A Very Powerfull AI Powered Image processing platform</p>
          <Link href={"/sign-up"}>
